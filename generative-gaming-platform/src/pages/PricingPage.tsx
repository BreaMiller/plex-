...
const PricingPage: React.FC = () => {
  const pricingActions = [
    ...
    },
    {
      ...
      action: 'Play a Game',
      cost: 10,
      description: 'Access and play any game hosted on the Spazz platform.',
      ...
      <FadeInSection>
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent mb-2">
            Spazz Credits & Pricing
          </h1>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Spazz operates on a credit system to reward creation and engagement. Credits power everything from game generation to gameplay.
          </p>
        </div>
      </FadeInSection>
      ...
      <FadeInSection delay={600}>
        <div className="text-center">
          <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-xl rounded-2xl border border-purple-400/30 p-8">
            ...
            <p className="text-slate-300 mb-6">Join thousands of creators building amazing games with Spazz.</p>
